...
export class Tab1Page {
  ...
  async sendToWhatsapp() {
    ...
    window.open(`https://api.whatsapp.com/send?phone=087776351316&text=${output}`, '_blank');
  ...
  async sendToTelegram() {
    ...
    window.open(`https://t.me/+K1h8oSiWTzg1ZGM1=${output}`, '_blank');
  }
  ...
  async sendToEmail() {
    ...
    const url = `mailto:maulana.arif.667788@gmail.com?subject=Data&20Informasi&body=${output}`;
